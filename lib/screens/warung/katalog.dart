import 'dart:convert';
import 'package:e_warung/screens/warung/detail_katalog.dart';
...
import 'package:e_warung/models/warung/kategori.dart';
...
class _KatalogState extends State<Katalog> {
  ...
  Future getKategori() async {
    final response = await http.get(Uri.parse("${Env.URL_PREFIX}/kategori"));
