...
import 'package:e_warung/screens/warung/detail_stok_warung.dart';
import 'package:flutter/material.dart';
import 'package:flutter/rendering.dart';
import 'package:e_warung/models/warung/stok_warung.dart';
import 'package:e_warung/env.dart';

class StokWarung extends StatefulWidget {
  const StokWarung({Key? key}) : super(key: key);

  @override
  _StokWarungState createState() => _StokWarungState();
}

class _StokWarungState extends State<StokWarung> {
  ...
  Future<List<StokWarungModels>> getStokWarung() async {
    final response =
        await http.get(Uri.parse("${Env.URL_PREFIX}/stok-warung?w=1"));
