            ...
            Row(children: [
              Expanded(
                child: Container(
                  ...
                  child: Icon(Icons.production_quantity_limits,size:45,color:Colors.white)
                ))
              ]
            ),
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                Text("Rp.20.000",style:TextStyle(fontWeight: FontWeight.bold,fontSize:30)),
                SizedBox(height:10),
                      ...
                      child:Row(
                        ...
                        children:[
                          IconButton(
                            ...
                            icon: Icon(Icons.remove,color: ((){if(_counter == 0){return Colors.grey;}else{return Colors.blue;}}()) )
                          ),
                  ...
                  Row(
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Text("Pcs",style: TextStyle(color:_radioText))
                      ),
                    ),
                    SizedBox(width:15),
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Text("Paket",style: TextStyle(color:_radioText))
                      ),
                    ),
                    SizedBox(width:15),
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Text("Kg",style: TextStyle(color:_radioText))
                      ),
                    ),
